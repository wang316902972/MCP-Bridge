...
Proxy MCP stdio protocol to remote HTTP endpoint (192.168.136.224:8007/mcp)
"""
import sys
import json
import subprocess
...
# Configuration
MCP_BRIDGE_URL = os.environ.get("MCP_BRIDGE_URL", "http://192.168.136.224:8007/mcp")
...
def main():
    """Main stdio loop - reads from stdin, writes to the stdout"""
    req_id_counter = 0
